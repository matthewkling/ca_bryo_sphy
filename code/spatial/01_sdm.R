...
# fit models
sdm <- function(sigma = 25, outdir = "results/sdm/"){
      
      plan(multisession, workers = 8)
      
      future_map(split(occ, occ$name), function(pres){
            ...
            # fit and project proximity model
            ...
            # combine climate, proximity, and intactness; save output
            pred <- suit * prox * intactness
            saveRDS(pred, paste0(outdir, pres$name[1], ".rds"))
            return("success")
      })
}

sdm(sigma = 25, outdir = "results/sdm/")
